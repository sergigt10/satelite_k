                    ...
                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-12">
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <img class="ps-product__image" src='{{ asset("/storage/$noticia->foto_mini") }}' alt="{{ $noticia->titol_esp }} - Satélite K"/>
                            ...
                            <div class="ps-product__content">
                                <a class="ps-product__title" href="{{ route('frontend.noticies.show', ['noticia' => $noticia->slug]) }}">
                                    <b>{{ ( app()->getLocale() === 'ca' ) ? $noticia->titol_cat : $noticia->titol_esp }}</b>
                                </a>
                                <a class="ps-product__subtitle-blog" href="{{ route('frontend.noticies.show', ['noticia' => $noticia->slug]) }}">
