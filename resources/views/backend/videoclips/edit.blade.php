                        ...
                        <form class="forms-sample" method="post" action="{{ route('backend.videoclips.update', ['videoclip' => $videoclip->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="discos_id" name="discos_id" class="form-control js-example-basic-single w-100">
                                    <option 
                                        value="0"
                                        {{ $videoclip->discos_id === 0 ? 'selected' : '' }} 
                                    >
                                    ...
                                    @foreach ($discos as $disc)
                                        <option 
                                            value="{{ $disc->id }}"
                                            {{ $videoclip->discos_id == $disc->id ? 'selected' : '' }}
                                        >
                                            {{ $disc->titol }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input name="embed_youtube" type="text" class="form-control" id="exampleInputEmail3" placeholder="Link Youtube *" value="https://www.youtube.com/watch?v={{ $videoclip->embed_youtube }}">
                            </div>
