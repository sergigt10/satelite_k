                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{ route('backend.noticies.update', ['noticia' => $noticia->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="embed_1" type="text" class="form-control" id="exampleInputEmail3" placeholder="Embed 1" value="{{ $noticia->embed_1 }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3"><i class="mdi mdi-spotify"></i><i class="mdi mdi-youtube"></i> Embed 2:</label>
                                <input name="embed_2" type="text" class="form-control" id="exampleInputEmail3" placeholder="Embed 2" value="{{ $noticia->embed_2 }}">
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                @if ($noticia->foto2)
                                                    <div class="form-group col-md-3">
                                                        <div class="form-check form-check-danger" style="float:right;">
                                                            ...
                                                            Esborrar imatge 2?
                                                            <br><br>
                                                            <img src='{{ asset("/storage/$noticia->foto2") }}' alt="Satélite K" with=200 height=92>
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input name="alt_foto2" type="text" class="form-control @error('alt_foto2') is-invalid @enderror" id="exampleInputEmail3" placeholder="Alt imatge 2" value="{{ $noticia->alt_foto2 }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
